<template>
  <div class="min-h-screen bg-gray-50 p-4">
    ...
    <div
      v-if="showFormModal"
      class="fixed inset-0 backdrop-blur-sm bg-opacity-30 flex items-center justify-center p-4 z-50"
    >
    ...
    <div
      ...
      class="fixed inset-0 backdrop-blur-sm bg-opacity-50 flex items-center justify-center p-4 z-50"
    >
      <div class="bg-white rounded-lg shadow-xl max-w-md w-full">
        <div class="p-6">
          <h2 class="text-xl font-bold text-gray-900 mb-4">Supprimer la tâche</h2>
          <p class="text-gray-600 mb-6">
            Êtes-vous sûr de vouloir supprimer la tâche "{{ taskToDelete?.title }}" ? Cette action
            est irréversible.
          </p>
